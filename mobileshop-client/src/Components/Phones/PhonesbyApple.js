          ...
          <div>
            ...
            <div class="row">
              {this.state.apple.map(apple => (
                <div class="col-md-4 mt-3" key={apple.phone_id}>

                  <div class="card profile-card-5">
                    <div class="card-img-block">
                      <img class="card-img-top" style={{ width: "400px", height: "400px" }} src={`http://localhost:3001/Assets/Images/${apple.imagename}`} />
                    </div>
                    <div class="card-body pt-0">
                      <h5 class="card-title">{apple.brand_name}</h5>
                      <p class="card-text">{apple.model_name}</p>
                      <p class="card-text">€{apple.price}</p>
                      <a class="btn btn-success" data-toggle="modal" data-target={`#appledetail${apple.phone_id}`}>More Details</a>



                    </div>
                  </div>
                  <div id={`appledetail${apple.phone_id}`} class="modal fade" role="dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="row">
                            ...
                            <p class="col-sm-7 textline">{apple.brand_name}</p>
                          </div>

                          <div class="row">
                            <p class="col-sm-5 text"><b>Model Name:</b></p>
                            <p class="col-sm-7 textline">{apple.model_name}</p>
                          </div>

                          <div class="row">
                            <p class="col-sm-5 text"><b>Storage Capacity:</b></p>
                            <p class="col-sm-7 textline">{apple.storage_capacity}</p>
                          </div>

                          <div class="row">
                            <p class="col-sm-5 text"><b>Color:</b></p>
                            <p class="col-sm-7 textline">{apple.color}</p>
                          </div>

                          <div class="row">
                            <p class="col-sm-5 text"><b>Price:</b></p>
                            <p class="col-sm-7 textline">€{apple.price}</p>
                          </div>
                        </div>

                        <div class="modal-footer">
                          <a class="btn btn-default" data-dismiss="modal">Close</a>
                          <a class="btn btn-success" data-toggle="modal" data-target={`#buyapple${apple.phone_id}`} data-dismiss="modal">Buy</a>
                        </div>
                  ...
                  <div id={`buyapple${apple.phone_id}`} class="modal fade" role="dialog">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
