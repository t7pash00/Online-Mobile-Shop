...
//   });
// });
// router.get('/loginby/:email/pass/:pass', function(req, res, next) {
//   customers.getRegisteredcustomer(req.params.email,req.params.pass, function(err, rows) {
//     if (err) {
//       res.json(err);
//     } else {
//       res.json(rows); 
...
router.post('/loginby', function (req, res, next) {

  console.log(req.body.email);
  customers.getRegisteredcustomer(req.body.email, req.body.pass, function (err, rows) {
    if (err) {
      res.json(err);
    } else {
      res.json(rows);
